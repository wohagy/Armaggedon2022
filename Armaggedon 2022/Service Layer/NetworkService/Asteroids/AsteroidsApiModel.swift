...
// MARK: - AsteroidsAPIModel

struct AsteroidsAPIModel: Codable {
    let links: AsteroidsAPIModelLinks
...
// MARK: - AsteroidsAPIModelLinks

struct AsteroidsAPIModelLinks: Codable {
